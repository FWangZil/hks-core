...
type Event struct {
	...
	Longitude  decimal.Decimal `json:"longitude" gorm:"type:decimal(15,5)" form:"longitude"` // 经度
	Latitude   decimal.Decimal `json:"latitude" gorm:"type:decimal(15,5)" form:"latitude"`   // 维度
...
type WarningArea struct {
	GormModel
	Longitude1 decimal.Decimal `json:"longitude1" gorm:"type:decimal(15,5)"` // 经度1
	Latitude1  decimal.Decimal `json:"latitude1" gorm:"type:decimal(15,5)"`  // 维度1
	Longitude2 decimal.Decimal `json:"longitude2" gorm:"type:decimal(15,5)"` // 经度2
	Latitude2  decimal.Decimal `json:"latitude2" gorm:"type:decimal(15,5)"`  // 维度2
